...
2. **ระบบส่วนลดสมาชิกตามระดับ (Dynamic Loyalty Discounts)**:
   - พัฒนาให้เครื่องแคชเชียร์ POS คำนวณส่วนลดอาหารและน้ำดื่มโดยอัตโนมัติตามระดับสมาชิกที่ผูกอยู่:
     - *Common*: ได้รับคูณแต้ม 1.0 เท่า
     - *People*: ส่วนลดบิล 5% หรือตัวคูณแต้ม 1.25 เท่า
     - *Inner Haus*: ส่วนลดบิล 10% หรือตัวคูณแต้ม 1.5 เท่า
