                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div className="relative hidden sm:block">
                            ...
                            <input
                                ...
                                className="bg-gray-50 border border-gray-200 rounded-xl py-2 pl-9 pr-4 text-sm font-medium focus:outline-none focus:ring-2 focus:ring-purple-200 focus:bg-white w-48 lg:w-64 transition-all"
                                value={searchQuery}
                         ...
                         <button 
                            ...
                            className="bg-purple-600 text-white px-4 py-2 rounded-xl font-bold flex items-center gap-2 hover:bg-purple-700 shadow-lg text-sm whitespace-nowrap"
                        >
