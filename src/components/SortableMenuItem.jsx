...
import { GripVertical, Pencil, Trash2, Star, Lock, FileText } from 'lucide-react';
    ...
    return (
      ...
      >
        ...
        <div className="flex gap-2">
           <button onClick={() => onRecipe(item)} className="p-2 text-gray-500 hover:text-blue-400 transition-colors"><FileText size={16}/></button>
        ...
        <div className="flex justify-between items-center mt-4 border-t border-white/5 pt-3">
            <span className="text-xs text-gray-600 uppercase tracking-wider font-medium">{item.category}</span>
             <div className="flex gap-1">
                <button onClick={() => onRecipe(item)} className="p-2 hover:bg-white/5 rounded-lg text-gray-400 hover:text-blue-400 transition-colors" title="จัดการสูตร (Recipe)"><FileText size={16} /></button>
