        ...
        async function fetchShopData() {
            try {
                ...
                setSettings({
                    ...
                    promptpayId: settingsMap.promptpay_id || '0614232455',
                    promptpayName: settingsMap.promptpay_name || settingsMap.bank_account_name || 'ธัญญธร ศรีวิเศษ',
                    ...
                    bankAccountName: settingsMap.bank_account_name || settingsMap.promptpay_name || 'ธัญญธร ศรีวิเศษ',
