      ...
      <div className="w-full max-w-4xl mx-auto flex flex-col justify-center space-y-12 md:space-y-16 z-10">
        ...
        {item.id === 1 && (
            <motion.div 
                ...
                className="absolute top-16 right-8 md:top-24 md:right-16 text-[#DFFF00] font-black text-4xl md:text-6xl leading-none font-['Space_Mono'] drop-shadow-lg z-0 opacity-80"
                style={{ WebkitTextStroke: '2px #1A1A1A' }}
            >
                <div>MADE!</div>
                <div>IT BOLD</div>
                <div className="text-xl md:text-2xl mt-1 text-center bg-[#1A1A1A] text-[#DFFF00] rounded-full w-12 h-12 flex items-center justify-center ml-auto border-4 border-[#DFFF00]">TH</div>
            </motion.div>
        )}
