                ...
                {tables.map((table) => (
                    ...
                    >
                        ...
                        <div className={`absolute top-0 right-0 w-2 h-2 rounded-full m-4 ${
                            table.status === 'occupied' ? 'bg-red-500 animate-pulse shadow-[0_0_10px_rgba(239,68,68,0.5)]' : 'bg-green-500'
                        }`} />

                        <div className="flex flex-col items-center gap-2">
                             <div className={`w-12 h-12 rounded-2xl flex items-center justify-center ${table.status === 'occupied' ? 'bg-red-500/20' : 'bg-white/5'}`}>
                                <Users size={24} className={table.status === 'occupied' ? 'text-red-400' : 'text-gray-400'} />
                             </div>
